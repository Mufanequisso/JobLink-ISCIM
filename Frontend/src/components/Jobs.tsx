...
import {
  Briefcase, MapPin, Building, Clock, DollarSign, Wifi,
  Search, Filter, X, ChevronDown, ChevronUp, Send, Check, Upload,
  User, FileText, Award, Grid, List, BarChart3, ChartPie,
  Heart, ArrowRight, Calendar, Users, Globe, Home, Star
} from 'lucide-react';
import {
...
const Jobs: React.FC = () => {
  ...
  const [activeView, setActiveView] = useState('jobs'); // 'jobs' ou 'profile'
      ...
      try {
        ...
        setJobs([
          ...
          },
          {
            ...
            description: 'Criação de interfaces intuitivas and experiências de usuário excepcionais. Trabalhe com produtos digitais inovadores em um ambiente colaborativo e criativo.',
  ...
  const handleMenuItemClick = (itemId: string) => {
    ...
    if (itemId === 'profile') {
      ...
      setActiveView('applications'); // Adicione esta linha
    } else {
      setActiveView('jobs');
    }
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-orange-50 to-rose-50 flex">
      <Sidebar
        user={user}
        ...
        onMenuItemClick={handleMenuItemClick} // Passando a função correta
      />
        ...
        <div className="flex-1">
          {loading ? (
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
              {activeView === 'profile' ? (
                <Profile />
              ) : activeView === 'applications' ? ( // Adicione esta condição
                <Applications />
              ) : (
                <>
                    ...
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                      ...
                      <div className="flex items-center gap-4">
                        <button
                          ...
                          className={`group relative px-4 py-2 rounded-xl font-medium transition-all duration-300 ${showCharts
                  ...
                  <div className={viewMode === 'grid'
                    ...
                    {filteredJobs.map((job) => (
                      <div key={job.id} className="group relative">
                        ...
                        <div className={`relative bg-white/80 backdrop-blur-lg shadow-xl rounded-2xl overflow-hidden border border-white/20 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 ${viewMode === 'grid' ? 'h-full flex flex-col' : ''
                          }`}>
                          ...
                          <div className="p-6 pb-4">
                            <div className="flex justify-between items-start mb-4">
                              ...
                              <button
                                ...
                                className={`p-2 rounded-xl transition-all duration-300 ${savedJobs.includes(job.id)
                            ...
                            <div className="flex flex-wrap gap-2 mb-4">
                              <span className={`px-3 py-1 rounded-full text-sm font-medium shadow-sm ${job.type === 'full-time' ? 'bg-gradient-to-r from-blue-100 to-blue-200 text-blue-800' :
                  ...
                  {filteredJobs.length === 0 && (
                    <div className="group relative">
                      ...
                      <div className="relative bg-white/80 backdrop-blur-lg shadow-xl rounded-2xl p-12 text-center border border-white/20">
                        ...
                        <p className="text-gray-600 mb-6">Tente ajustar os filtros or termos de busca para descobrir novas vagas.</p>
                        <button
                          onClick={() => {
                            setSearchTerm('');
                            setSelectedType('all');
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                  ...
                                  <input
                                    ...
                                    className={`w-full px-4 py-3 bg-white/80 border-2 rounded-xl focus:ring-4 focus:ring-orange-500/20 focus:border-orange-500 transition-all duration-300 ${formErrors.name ? 'border-red-500' : 'border-gray-200'
                                      }`}
                                ...
                                <div>
                                  ...
                                  <input
                                    ...
                                    onChange={handleInputChange}
                                    className={`w-full px-4 py-3 bg-white/80 border-2 rounded-xl focus:ring-4 focus:ring-orange-500/20 focus:border-orange-500 transition-all duration-300 ${formErrors.email ? 'border-red-500' : 'border-gray-200'
                                      }`}
                                ...
                                <div className="md:col-span-2">
                                  ...
                                  <input
                                    ...
                                    onChange={handleInputChange}
                                    className={`w-full px-4 py-3 bg-white/80 border-2 rounded-xl focus:ring-4 focus:ring-orange-500/20 focus:border-orange-500 transition-all duration-300 ${formErrors.phone ? 'border-red-500' : 'border-gray-200'
                                      }`}
